...
import { setFilterRating, setFilterBestSeller, setFilterSortBy, setFilterInStock, clearFilter } from "../../../store/productSlice";

export const FilterBar = ({ setShow }) => {
  const dispatch = useDispatch();

  const { filterSortBy, filterRating, filterInStock, filterBestSeller } = useSelector(state => state.products); 
    return (
              ...
              <li className="mt-1 mb-5">
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    onChange={ () => dispatch(setFilterSortBy({sortBy: 'low-to-high'})) }
                    checked={filterSortBy === 'low-to-high'}
                  />
                  <label
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    name="price-sort"
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    onChange={ () => dispatch(setFilterSortBy({sortBy: 'high-to-low'})) }
                    checked={filterSortBy === 'high-to-low'}
                  />
                  <label
              ...
              <li className="mt-1 mb-5">
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    name="rating-sort"
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    onChange={()=> dispatch(setFilterRating({rating: 'four-and-above'}))}
                    checked={filterRating === "four-and-above"}
                  />
                  <label
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    name="rating-sort"
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    onChange={()=> dispatch(setFilterRating({rating: 'three-and-above'}))}
                    checked={filterRating === "three-and-above"}
                  />
                  <label
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    name="rating-sort"
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    onChange={()=> dispatch(setFilterRating({rating: 'two-and-above'}))}
                    checked={filterRating === "two-and-above"}
                  />
                  <label
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    name="rating-sort"
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    onChange={()=> dispatch(setFilterRating({rating: 'one-and-above'}))}
                    checked={filterRating === "one-and-above"}
                  />
                  <label
              ...
              <li className="mt-1 mb-5">
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    onChange={()=> dispatch(setFilterBestSeller({bestSeller: !filterBestSeller}))}
                ...
                <div className="flex items-center my-1">
                  <input
                    ...
                    value=""
                    className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                    onChange={ () => dispatch(setFilterInStock({inStock: !filterInStock})) }
